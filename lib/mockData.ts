import type { Exam, Script, RubricQuestion, GradingResult, ActivityItem } from '@/types';
...
export const mockRubric: RubricQuestion[] = [
  {
    id: 'q1',
    questionNumber: 'Q1',
    questionText: 'Explain the ACID properties of database transactions and provide an example of each.',
    totalMarks: 20,
    parts: [
      {
        id: 'q1a',
        ...
        keyPoints: ['all-or-nothing', 'commit', 'rollback', 'bank transfer example'],
        marks: 5,
      },
      {
        id: 'q1b',
        ...
        keyPoints: ['integrity constraints', 'valid state', 'rules', 'referential integrity'],
        marks: 5,
      },
      {
        id: 'q1c',
        ...
        keyPoints: ['concurrency', 'dirty read', 'non-repeatable read', 'serializable', 'isolation levels'],
        marks: 5,
      },
      {
        id: 'q1d',
        ...
        keyPoints: ['committed', 'system failure', 'write-ahead log', 'checkpoints', 'persistence'],
        marks: 5,
      },
    ],
  },
  {
    id: 'q2',
    questionNumber: 'Q2',
    questionText: 'Compare and contrast the relational model with the NoSQL document model.',
    totalMarks: 20,
    parts: [
      {
        id: 'q2a',
      ...
      },
      {
        ...
        keyPoints: ['JSON', 'BSON', 'schema-less', 'horizontal scaling', 'nested documents', 'MongoDB'],
        marks: 8,
      },
      {
        id: 'q2c',
        ...
        keyPoints: ['consistency', 'scalability', 'trade-offs', 'use cases', 'CAP theorem'],
        marks: 4,
      },
    ],
  },
...
export const mockGradingResults: GradingResult[] = [
  ...
  },
  {
    ...
    missingConcepts: ['dirty read', 'non-repeatable read', 'serializable', 'isolation levels'],
  },
  {
    questionId: 'q1',
    questionNumber: 'Q1',
    ...
    similarityScore: 94,
    confidence: 96,
    matchedConcepts: ['committed', 'system failure', 'write-ahead log', 'persistence'],
    missingConcepts: [],
  },
  {
    questionId: 'q2',
...
export const mockActivity: ActivityItem[] = [
  {
    id: 'a1',
    type: 'processed',
    description: 'Script for Adaeze Okonkwo (STU-2021-0044) processed successfully.',
  ...
  },
  {
    id: 'a2',
    type: 'upload',
    description: '3 new scripts uploaded for Database Systems — Final Examination.',
  ...
  },
  {
    id: 'a3',
    type: 'reviewed',
    description: 'Score override applied for Fatima Al-Hassan — Q1c revised to 4/5.',
  ...
  },
  {
    id: 'a4',
    type: 'processed',
    description: 'Batch of 12 scripts completed for Software Engineering Principles.',
  ...
  },
  {
    id: 'a5',
    type: 'exam_created',
    description: 'New exam created: Computer Networks — Theory Paper (CSC 415).',
  ...
  },
  {
    id: 'a6',
    type: 'reviewed',
    description: 'Final results exported for Software Engineering Principles (64 scripts).',
